...
clean:
	del /F /Q main.exe
	for %%I in (C:\Users\Propietario\OneDrive\Escritorio\CompiladorFinal\build\*.o C:\Users\Propietario\OneDrive\Escritorio\CompiladorFinal\build\helpers\*.o) do del /F /Q %%I